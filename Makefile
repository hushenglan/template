...
GTEST_OBJS = $(PRIMER_OBJS_DIR)/stack1.o $(PRIMER_OBJS_DIR)/max4.o $(PRIMER_OBJS_DIR)/max3.o $(PRIMER_OBJS_DIR)/max2.o $(PRIMER_OBJS_DIR)/max.o $(PRIMER_OBJS_DIR)/abs.o $(OBJS_DIR)/template_test.o $(OBJS_DIR)/gtest_blue.o
